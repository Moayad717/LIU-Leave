...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4 bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/60">
      ...
      <Card className="w-full max-w-md shadow-2xl shadow-blue-900/10 border border-white/80 bg-white/80 backdrop-blur-sm relative z-10">
        <CardHeader className="text-center space-y-4 pb-6 pt-8">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">LIU Leave</CardTitle>
        ...
        <CardContent className="space-y-4 pb-8">
          <p className="text-center text-sm text-muted-foreground">
            Sign in with your LIU institutional Google account to continue.
          </p>
          ...
          >
            <Button type="submit" className="w-full gap-2 shadow-sm" size="lg">
          ...
          <p className="text-center text-xs text-muted-foreground">
            Access restricted to <strong>@liu.edu.lb</strong> accounts only.
          </p>
        </CardContent>
      </Card>
    </div>
